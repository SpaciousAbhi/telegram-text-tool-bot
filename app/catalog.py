...
STYLE_TOOLS = [
    ...
    ToolDefinition("bold_text", "Bold Text Generator", STYLE_CATEGORY, "🅱️", "Send the text you want to convert into bold Unicode text.", "bold Unicode text"),
    ToolDefinition("italic_text", "Italic Text Generator", STYLE_CATEGORY, "✒️", "Send the text you want to convert into italic Unicode text.", "italic Unicode text"),
    ...
    ToolDefinition("strikethrough_text", "Strikethrough Text Generator", STYLE_CATEGORY, "〰️", "Send the text you want to strike through.", "strikethrough text"),
    ToolDefinition("monospace_text", "Monospace Text Generator", STYLE_CATEGORY, "⌨️", "Send the text you want to convert into monospace Unicode text.", "monospace Unicode text"),
    ...
    ToolDefinition("fonts_preview", "Fonts Preview", STYLE_CATEGORY, "👁️", "Send text to preview it in multiple font styles at once.", "font comparison preview"),
    ToolDefinition("stylish_name", "Stylish Name Generator", STYLE_CATEGORY, "🏷️", "Send a name, username, nickname, gaming name, or channel name.", "stylish name ideas"),
...
UTILITY_TOOLS = [
    ...
    ToolDefinition("duplicate_line_remover", "Duplicate Line Remover", UTILITY_CATEGORY, "♻️", "Send text or a list with repeated lines.", "deduplicated text"),
    ToolDefinition("extra_space_remover", "Extra Space Remover", UTILITY_CATEGORY, "↔️", "Send text with extra spaces or blank lines.", "space-cleaned text"),
